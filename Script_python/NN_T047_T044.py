...
conf_T047_train, conf_T047_test, msd_T047_train, msd_T047_test = train_test_split(conf_T047, msd_T047, shuffle = True, train_size = 0.8, random_state = 1234) 
conf_T050_train, conf_T050_test, msd_T050_train, msd_T050_test = train_test_split(conf_T050, msd_T050, shuffle = True, train_size = 0.8, random_state = 1234) 
conf_T056_train, conf_T056_test, msd_T056_train, msd_T056_test = train_test_split(conf_T056, msd_T056, shuffle = True, train_size = 0.8, random_state = 1234)
...
class Dataset(object): #Is object really useful?
    def __init__(self, partition = 'train', num_points = 4096):  
        if partition == 'train':
           self.data, self.label = conf_T047_train, msd_T047_train # Train
        else: 
