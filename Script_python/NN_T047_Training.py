...
class Dataset(object): 
    def __init__(self, partition = 'train', num_points = 4096): # va specificato il numero di punti anche alla riga 86?
        if partition == 'train':
           self.data, self.label = conf_T047_train, msd_T047_train
...
model_name = 'DGCNN_k20_e30_bs16_cpMax_T047_Training.h5'
...
model.load_weights("model_checkpoints/DGCNN_k20_e30_bs16_cpMax_T047_Training.h5")
...
#predicted value for new unlabeled data (or pretend that you do not have a label)
...
#
np.save('predictions_k20_e30_bs16_cpMax_T047_Training_T044_test.npy', predictions_T044)
np.save('test_y_k20_e30_bs_16_cpMax_T047_Training_T044_test.npy', test_T044.y)

np.save('predictions_k20_e30_bs16_cpMax_T047_Training_T045_test.npy', predictions_T045)
np.save('test_y_k20_e30_bs_16_cpMax_T047_Training_T045_test.npy', test_T045.y)
#
np.save('predictions_k20_e30_bs16_cpMax_T047_Training_T047_test.npy', predictions_T047)
np.save('test_y_k20_e30_bs_16_cpMax_T047_Training_T047_test.npy', test_T047.y)

np.save('predictions_k20_e30_bs16_cpMax_T047_Training_T049_test.npy', predictions_T049)
np.save('test_y_k20_e30_bs_16_cpMax_T047_Training_T049_test.npy', test_T049.y)
#
np.save('predictions_k20_e30_bs16_cpMax_T047_Training_T050_test.npy', predictions_T050)
np.save('test_y_k20_e30_bs_16_cpMax_T047_Training_T050_test.npy', test_T050.y)

np.save('predictions_k20_e30_bs16_cpMax_T047_Training_T052_test.npy', predictions_T052)
np.save('test_y_k20_e30_bs_16_cpMax_T047_Training_T052_test.npy', test_T052.y)
#
np.save('predictions_k20_e30_bs16_cpMax_T047_Training_T056_test.npy', predictions_T056)
np.save('test_y_k20_e30_bs_16_cpMax_T047_Training_T056_test.npy', test_T056.y)
...
plt.savefig('TaV_Loss_MAE_k20_e30_bs16_cpMax_T047_Training.pdf')
