...
class Dataset(object): #Is object really useful?
    ...
    def _load(self):
        pointcloud = self.data[:, :4096, 1:4] # [configurazioni, numero particelle, tipo - coordinate - velocita'], in questo caso solo le posizioni [1:4]
        mask = np.ones(shape=(pointcloud.shape[0], pointcloud.shape[1],1))
        features = self.data[:, :4096, :] 
        self._label = self.label[:,[100,199],1]  #msd[tutte le 8000 configurazioni, tre valori, msd particelle tipo A] # predice solo 2 punti del msd, non 3 come in altri casi. Escluso il punto 0
...
#print(test_T044['points'].shape)
#print(test_T047['points'].shape)
#print(test_T050['points'].shape)
#print(test_T056['points'].shape)
#
#print(train['features'].shape)
#print(test_T044['features'].shape)
#print(test_T047['features'].shape)
#print(test_T050['features'].shape)
#print(test_T056['features'].shape)
#
#print(train['mask'].shape)
#print(test_T044['mask'].shape)
#print(test_T047['mask'].shape)
#print(test_T050['mask'].shape)
#print(test_T056['mask'].shape)
...
model_name = 'DGCNN_k20_e30_bs16_cpMax_Tutte_Training.h5'
...
history = model.fit(train.X, train.y,
          ...
          epochs = epochs,
          #validation_data = (test_T052_NT.X, test_T052_NT.y),
...
model.load_weights("model_checkpoints/DGCNN_k20_e30_bs16_cpMax_Tutte_Training.h5")
#model.load_weights("model_checkpoints/prova.h5")

predictions_T044 = model.predict(test_T044.X, verbose = 1) 
predictions_T045 = model.predict(test_T045.X, verbose = 1) 
predictions_T047 = model.predict(test_T047.X, verbose = 1) 
predictions_T049 = model.predict(test_T049.X, verbose = 1) 
predictions_T050 = model.predict(test_T050.X, verbose = 1) 
predictions_T052 = model.predict(test_T052.X, verbose = 1) 
predictions_T056 = model.predict(test_T056.X, verbose = 1) 

np.save('predictions_k20_e30_bs16_cpMax_Tutte_Training_T044_test.npy', predictions_T044)
np.save('test_y_k20_e30_bs_16_cpMax_Tutte_Training_T044_test.npy', test_T044.y)

np.save('predictions_k20_e30_bs16_cpMax_Tutte_Training_T045_test.npy', predictions_T045)
np.save('test_y_k20_e30_bs_16_cpMax_Tutte_Training_T045_test.npy', test_T045.y)
#
np.save('predictions_k20_e30_bs16_cpMax_Tutte_Training_T047_test.npy', predictions_T047)
np.save('test_y_k20_e30_bs_16_cpMax_Tutte_Training_T047_test.npy', test_T047.y)

np.save('predictions_k20_e30_bs16_cpMax_Tutte_Training_T049_test.npy', predictions_T049)
np.save('test_y_k20_e30_bs_16_cpMax_Tutte_Training_T049_test.npy', test_T049.y)
#
np.save('predictions_k20_e30_bs16_cpMax_Tutte_Training_T050_test.npy', predictions_T050)
np.save('test_y_k20_e30_bs_16_cpMax_Tutte_Training_T050_test.npy', test_T050.y)

np.save('predictions_k20_e30_bs16_cpMax_Tutte_Training_T052_test.npy', predictions_T052)
np.save('test_y_k20_e30_bs_16_cpMax_Tutte_Training_T052_test.npy', test_T052.y)
#
np.save('predictions_k20_e30_bs16_cpMax_Tutte_Training_T056_test.npy', predictions_T056)
np.save('test_y_k20_e30_bs_16_cpMax_Tutte_Training_T056_test.npy', test_T056.y)
...
plt.savefig('TaV_Loss_MAE_k20_e30_bs16_cpMax_Tutte_Training.pdf')
