...
array_msd_T052_NT = np.load('msd_completo_T052_P109_NT.npy') #[configurazioni, (questo campo deve scorrere coi :),  0 = tempi / 1 = msdA / 2 = msdB]
#tempo = 100
msdA = 1
msdB = 2
...
kwargs_solo_contorno = dict(histtype = 'step', alpha = 0.5,  bins = 'auto', density = True, linewidth = 2)
...
n, bins1, patches = ax1.hist(array_msd_T052_NT[:, 174, msdA], color = 'indianred', ec = 'indianred', **kwargs_solo_contorno, label = "T = 0.52, P = 1.09")
