...
ax2.plot(array_msd_T047_medie[:, 0], array_msd_T050_medie[:, msdA], color = 'orange', label = "T = 0.50, P = 1.55")
ax2.plot(array_msd_T047_medie[:, 0], array_msd_T056_medie[:, msdA], color = 'tab:red', label = "T = 0.56, P = 0.17")


## Predizioni medie singole configurazioni
#T = 0.44, P = 2.93

ax2.plot(0,   predizioni_msd_T044[:,0].mean() , color = 'tab:blue', marker = 'o')
ax2.plot(100, predizioni_msd_T044[:,1].mean() , color = 'tab:blue', marker = 'o') 
ax2.plot(199, predizioni_msd_T044[:,2].mean() , color = 'tab:blue', marker = 'o')
##

#T = 0.47, P = 2.24

ax2.plot(0,   predizioni_msd_T047[:,0].mean() , color = 'mediumseagreen', marker = 's')
ax2.plot(100, predizioni_msd_T047[:,1].mean() , color = 'mediumseagreen', marker = 's' )
ax2.plot(199, predizioni_msd_T047[:,2].mean() , color = 'mediumseagreen', marker = 's' )

#T = 0.50, P = 1.55

ax2.plot(0,   predizioni_msd_T050[:,0].mean() , color = 'orange', marker = 'p')
ax2.plot(100, predizioni_msd_T050[:,1].mean() , color = 'orange', marker = 'p')
ax2.plot(199, predizioni_msd_T050[:,2].mean() , color = 'orange', marker = 'p' )

#T = 0.56, P = 0.17

ax2.plot(0,   predizioni_msd_T056[:,0].mean() , color = 'tab:red', marker = '^')
ax2.plot(100, predizioni_msd_T056[:,1].mean() , color = 'tab:red', marker = '^')
ax2.plot(199, predizioni_msd_T056[:,2].mean() , color = 'tab:red', marker = '^')
