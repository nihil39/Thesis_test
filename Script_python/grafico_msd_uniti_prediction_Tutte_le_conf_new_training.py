...
predizioni_msd_Tutte_T044 = np.load('../DGCNN/New_Training/Tutte_Training_new/predictions_k20_e30_bs16_cpMax_Tutte_Training_T044_test.npy')
predizioni_msd_Tutte_T047 = np.load('../DGCNN/New_Training/Tutte_Training_new/predictions_k20_e30_bs16_cpMax_Tutte_Training_T047_test.npy')
predizioni_msd_Tutte_T050 = np.load('../DGCNN/New_Training/Tutte_Training_new/predictions_k20_e30_bs16_cpMax_Tutte_Training_T050_test.npy')
predizioni_msd_Tutte_T056 = np.load('../DGCNN/New_Training/Tutte_Training_new/predictions_k20_e30_bs16_cpMax_Tutte_Training_T056_test.npy')

n_T044_t100, bins_Tutte_T044_t100 = np.histogram(predizioni_msd_Tutte_T044[:,0], bins = 'auto', density = True) # t = 100 [:,0]
n_T047_t199, bins_Tutte_T047_t199 = np.histogram(predizioni_msd_Tutte_T047[:,1], bins = 'auto', density = True) # t = 199 [:,1]

n_T056_t100, bins_Tutte_T056_t100 = np.histogram(predizioni_msd_Tutte_T056[:,0], bins = 'auto', density = True)  
n_T056_t199, bins_Tutte_T056_t199 = np.histogram(predizioni_msd_Tutte_T056[:,1], bins = 'auto', density = True)  
...
fig = plt.figure()
fig.suptitle('MSD with shaded error region\nNN trained on all conf, predictions on the training conf', fontsize = 14, c = 'darkgrey')
...
#t = 100
mu_Tutte_T044_t_100, sigma_Tutte_T044_t_100 = sp.stats.norm.fit(predizioni_msd_Tutte_T044[:,0])
mu_Tutte_T047_t_100, sigma_Tutte_T047_t_100 = sp.stats.norm.fit(predizioni_msd_Tutte_T047[:,0])

mu_Tutte_T050_t_100, sigma_Tutte_T050_t_100 = sp.stats.norm.fit(predizioni_msd_Tutte_T050[:,0])
#mu_T050_t_100_nuova, sigma_T050_t_100_nuova = sp.stats.norm.fit(nuove_predizioni_T050_t100)

mu_Tutte_T056_t_100, sigma_Tutte_T056_t_100 = sp.stats.norm.fit(predizioni_msd_Tutte_T056[:,0])

#t = 199
mu_Tutte_T044_t_199, sigma_Tutte_T044_t_199 = sp.stats.norm.fit(predizioni_msd_Tutte_T044[:,1])
mu_Tutte_T047_t_199, sigma_Tutte_T047_t_199 = sp.stats.norm.fit(predizioni_msd_Tutte_T047[:,1])

mu_Tutte_T050_t_199, sigma_Tutte_T050_t_199 = sp.stats.norm.fit(predizioni_msd_Tutte_T050[:,1])
#mu_T050_t_199_nuova, sigma_T050_t_199_nuova = sp.stats.norm.fit(nuove_predizioni_T050_t199)

mu_Tutte_T056_t_199, sigma_Tutte_T056_t_199 = sp.stats.norm.fit(predizioni_msd_Tutte_T056[:,1])

#T = 0.44, P = 2.93
#ax2.plot(1.63 , mu_T044_t_100, color = 'tab:blue', marker = 'o') 
#ax2.plot(500  , mu_T044_t_199, color = 'tab:blue', marker = 'o')
ax2.errorbar(1.63,  mu_Tutte_T044_t_100, yerr = sigma_Tutte_T044_t_100, fmt='o', color = 'tab:blue')
ax2.errorbar(500,  mu_Tutte_T044_t_199, yerr = sigma_Tutte_T044_t_199, fmt='o',color = 'tab:blue')
...
ax2.errorbar(1.63,  mu_Tutte_T047_t_100, yerr = sigma_Tutte_T047_t_100, fmt = 's', color = 'mediumseagreen')
ax2.errorbar(500,  mu_Tutte_T047_t_199, yerr = sigma_Tutte_T047_t_199, fmt = 's', color = 'mediumseagreen')
...
ax2.errorbar(1.63,  mu_Tutte_T050_t_100, yerr = sigma_Tutte_T050_t_100, fmt = 'p',color = 'orange')
#ax2.errorbar(500,  mu_Tutte_T050_t_199, yerr = sigma_Tutte_T050_t_199, fmt = 'p',color = 'orange')

n_Tutte_T050_t199, bins_Tutte_T050_t199 = np.histogram(predizioni_msd_Tutte_T050[:,1], bins = 'auto', density = True) # t = 199 [:,1]
...
ax2.errorbar(1.63,  mu_Tutte_T056_t_100, yerr = sigma_Tutte_T056_t_100, fmt='^', color = 'tab:red')
ax2.errorbar(500,  mu_Tutte_T056_t_199, yerr = sigma_Tutte_T056_t_199, fmt='^', color = 'tab:red')
