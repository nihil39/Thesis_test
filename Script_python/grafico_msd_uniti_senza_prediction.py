...
ax2.plot(array_msd_T045_NT_medie[:, 0], array_msd_T045_NT_medie[:, msdA], color = 'cornflowerblue', linestyle = 'dashed', label = "T = 0.45, P = 2.70 NT" ) #ax1.scatter per lo scatter plot
...
ax2.plot(array_msd_T052_NT_medie[:, 0], array_msd_T052_NT_medie[:, msdA], color = 'coral', linestyle = 'dashed', label = "T = 0.52, P = 1.09 NT")
