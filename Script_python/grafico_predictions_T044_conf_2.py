...
n, bins_T044_T050_t100, patches = ax1.hist(predizioni_T044_T050[:,0], bins = 'auto', color = 'xkcd:dusty red', ec = 'skyblue', density = True) # t = 100 [:,0]
n, bins_T044_T050_t199, patches = ax2.hist(predizioni_T044_T050[:,1], bins = 'auto', color = 'xkcd:algae', ec = 'skyblue', density = True) # t = 199 [:,1]

n, bins_T044_T052_t100, patches = ax3.hist(predizioni_T044_T052[:,0], bins = 'auto', color = 'xkcd:dusty red', ec = 'skyblue', density = True) # t = 100 [:,0]
n, bins_T044_T052_t199, patches = ax4.hist(predizioni_T044_T052[:,1], bins = 'auto', color = 'xkcd:algae', ec = 'skyblue', density = True) # t = 199 [:,1]

n, bins_T044_T056_t100, patches = ax5.hist(predizioni_T044_T056[:,0], bins = 'auto', color = 'xkcd:dusty red', ec = 'skyblue', density = True) # t = 100 [:,0]
n, bins_T044_T056_t199, patches = ax6.hist(predizioni_T044_T056[:,1], bins = 'auto', color = 'xkcd:algae', ec = 'skyblue', density = True) # t = 199 [:,1]
...
mu_T044_T050_t100, sigma_T044_T050_t100 = sp.stats.norm.fit(predizioni_T044_T050[:,0])
mu_T044_T050_t199, sigma_T044_T050_t199 = sp.stats.norm.fit(predizioni_T044_T050[:,1])

mu_T044_T052_t100, sigma_T044_T052_t100 = sp.stats.norm.fit(predizioni_T044_T052[:,0])
mu_T044_T052_t199, sigma_T044_T052_t199 = sp.stats.norm.fit(predizioni_T044_T052[:,1])

mu_T044_T056_t100, sigma_T044_T056_t100 = sp.stats.norm.fit(predizioni_T044_T056[:,0])
mu_T044_T056_t199, sigma_T044_T056_t199 = sp.stats.norm.fit(predizioni_T044_T056[:,1])

#rv = sp.stats.crystalball(-0.01, 3)

#mu_T044_T052_t100, sigma_T044_T052_t100, = sp.stats.crystalball.fit(predizioni_T044_T052[:,0])
