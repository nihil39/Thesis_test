...
n, bins_T047_T047_t100, patches = ax1.hist(predizioni_T047_T047[:,0], bins = 'auto', color = 'tab:blue', ec = 'skyblue', density = True) # t = 100 [:,0]
n, bins_T047_T047_t199, patches = ax2.hist(predizioni_T047_T047[:,1], bins = 'auto', color = 'mediumseagreen', ec = 'skyblue', density = True) # t = 199 [:,1]
...
mu_T047_T047_t100, sigma_T047_T047_t100 = sp.stats.norm.fit(predizioni_T047_T047[:,0])
mu_T047_T047_t199, sigma_T047_T047_t199 = sp.stats.norm.fit(predizioni_T047_T047[:,1])

#rv = sp.stats.crystalball(-0.01, 3)

#mu_T047_T047_t100, sigma_T047_T047_t100, = sp.stats.crystalball.fit(predizioni_T047_T047[:,0])
