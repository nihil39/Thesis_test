...
n, bins_T056_T044_t100, patches = ax1.hist(predizioni_T056_T044[:,0], bins = 'auto', color = 'xkcd:dusty red', ec = 'skyblue', density = True) # t = 100 [:,0]
n, bins_T056_T044_t199, patches = ax2.hist(predizioni_T056_T044[:,1], bins = 'auto', color = 'xkcd:algae', ec = 'skyblue', density = True) # t = 199 [:,1]

n, bins_T056_T045_t100, patches = ax3.hist(predizioni_T056_T045[:,0], bins = 'auto', color = 'xkcd:dusty red', ec = 'skyblue', density = True) # t = 100 [:,0]
n, bins_T056_T045_t199, patches = ax4.hist(predizioni_T056_T045[:,1], bins = 'auto', color = 'xkcd:algae', ec = 'skyblue', density = True) # t = 199 [:,1]

n, bins_T056_T047_t100, patches = ax5.hist(predizioni_T056_T047[:,0], bins = 'auto', color = 'xkcd:dusty red', ec = 'skyblue', density = True) # t = 100 [:,0]
n, bins_T056_T047_t199, patches = ax6.hist(predizioni_T056_T047[:,1], bins = 'auto', color = 'xkcd:algae', ec = 'skyblue', density = True) # t = 199 [:,1]
...
mu_T056_T044_t100, sigma_T056_T044_t100 = sp.stats.norm.fit(predizioni_T056_T044[:,0])
mu_T056_T044_t199, sigma_T056_T044_t199 = sp.stats.norm.fit(predizioni_T056_T044[:,1])

mu_T056_T045_t100, sigma_T056_T045_t100 = sp.stats.norm.fit(predizioni_T056_T045[:,0])
mu_T056_T045_t199, sigma_T056_T045_t199 = sp.stats.norm.fit(predizioni_T056_T045[:,1])

mu_T056_T047_t100, sigma_T056_T047_t100 = sp.stats.norm.fit(predizioni_T056_T047[:,0])
mu_T056_T047_t199, sigma_T056_T047_t199 = sp.stats.norm.fit(predizioni_T056_T047[:,1])

#rv = sp.stats.crystalball(-0.01, 3)

#mu_T056_T045_t100, sigma_T056_T045_t100, = sp.stats.crystalball.fit(predizioni_T056_T045[:,0])
