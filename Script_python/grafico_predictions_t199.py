...
T050_t199_low_threshold = 4.09
nuove_predizioni_T050_t199 = np.delete(predizioni_T050[:,1], np.argwhere(predizioni_T050[:,1] < T050_t199_low_threshold) )
...
n, bins_T044, patches = ax1.hist(predizioni_T044[:,1], bins = 'auto', color = 'tab:blue', ec = 'skyblue', density = True)
n, bins_T047, patches = ax2.hist(predizioni_T047[:,1], bins = 'auto', color = 'mediumseagreen', ec = 'skyblue', density = True)
#n, bins_T050, patches = ax3.hist(predizioni_T050[:,1], bins = 'auto', color = 'orange',  ec = 'skyblue', density = True)
n, bins_T050_t199_nuova, patches = ax3.hist(nuove_predizioni_T050_t199, bins = 'auto',  color = 'orange',  ec = 'skyblue', density = True)
n, bins_T056, patches = ax4.hist(predizioni_T056[:,1], bins = 'auto', color = 'tab:red', ec = 'skyblue', density = True)

mu_T044, sigma_T044 = sp.stats.norm.fit(predizioni_T044[:,1])
mu_T047, sigma_T047 = sp.stats.norm.fit(predizioni_T047[:,1])
...
mu_T056, sigma_T056 = sp.stats.norm.fit(predizioni_T056[:,1])
...
ax3.set_title(f'T = 0.50 P = 1.55')
ax3.text(0.1, 0.8, f'μ = {mu_T050_t199_nuova:.4f}\nσ = {sigma_T050_t199_nuova:.4f}\ncv = {cv_T050_t199_nuova:.3f}', fontsize = 10,  transform = ax3.transAxes)
...
ax3.plot(bins_T050_t199_nuova, best_fit_line_T050_t199_nuova)
