...
mu6, sigma6 = sp.stats.norm.fit(msd_T047[:,100,1])
...
ax1.set_title('T = 0.44 P = 2.93 \n t = 0')
ax1.text(0.1, 0.8, f'mu = {mu1:.9f} \nsigma = {sigma1:.9f} ', fontsize = 10,  transform = ax1.transAxes)

ax2.set_title('T = 0.47 P = 2.24 \n t = 0')
ax2.text(0.1, 0.8, f'mu = {mu2:.9f} \nsigma = {sigma2:.9f} ', fontsize = 10,  transform = ax2.transAxes)

ax3.set_title('t = 100')
ax3.text(0.1, 0.8, f'mu = {mu3:.4f} \nsigma = {sigma3:.4f} ', fontsize = 10,  transform = ax3.transAxes)

ax4.set_title('t = 100')
ax4.text(0.1, 0.8, f'mu = {mu4:.4f} \nsigma = {sigma4:.4f} ', fontsize = 10,  transform = ax4.transAxes)

ax5.set_title('t = 199')
ax5.text(0.1, 0.8, f'mu = {mu5:.4f} \nsigma = {sigma5:.4f} ', fontsize = 10,  transform = ax5.transAxes)

ax6.set_title('t = 199')
ax6.text(0.1, 0.8, f'mu = {mu6:.4f} \nsigma = {sigma6:.4f} ', fontsize = 10,  transform = ax6.transAxes)
